...
function UnifiedInvoicesSection() {
  ...
  return (
    <div id="unified-invoices-section">
      ...
      {viewRole === 'client' ? (
        <ClientInvoicesSection key="client-invoices" />
      ) : (
        <VendorInvoicesSection key="vendor-invoices" />
      )}
    </div>
  );
}

export default UnifiedInvoicesSection;
